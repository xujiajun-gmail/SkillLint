...
- Use this page as the authoritative reference for **javascript-modules-plugin-hooks**.
...
Reference: https://rspack.rs/zh/api/plugin-api/javascript-modules-plugin-hooks
